...
public class Problem03 {
    public static void main(String[] args) {
        ...
        ArrayListIntN numbers = new ArrayListIntN();
    ...
    private static void reverse(ArrayListIntN numbers){
    ...
    private static void addZerosBeforeEvenValues(ArrayListIntN numbers){
    ...
    private static void removeOddValues(ArrayListIntN numbers){
        for(int i = 0; i < numbers.size(); i++){
            if(numbers.get(i) % 2 != 0){
                numbers.remove(i);
